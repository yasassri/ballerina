...
/**
 * Test Ballerina test functions with logs.
 */
public class LogsTest {

    private Path[] filePaths = { Paths.get("src/test/resources/log-config-test/log-test.bal") };

    @Test
    public void logMessageInFunctionTest() {
